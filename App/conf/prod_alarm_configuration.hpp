...
const VirtualSensorData ALARM_ARM_SWITCH_ALL_ZONES = {1};
const VirtualSensorData ALARM_ARM_SWITCH_GARDEN = {1};
const VirtualSensorData ALARM_ARM_SWITCH_GARDEN_ALLEY = {1};
const VirtualSensorData ALARM_ARM_SWITCH_GARDEN_FRONT = {1};
const VirtualSensorData ALARM_ARM_SWITCH_INTERIORS = {1};

const VirtualSensorData ALARM_SECURITY_BREACH_ALL_ZONES = {1};
const VirtualSensorData ALARM_SECURITY_BREACH_GARDEN_ALLEY = {1};
const VirtualSensorData ALARM_SECURITY_BREACH_GARDEN_FRONT = {1};
const VirtualSensorData ALARM_SECURITY_BREACH_INTERIORS = {1};
